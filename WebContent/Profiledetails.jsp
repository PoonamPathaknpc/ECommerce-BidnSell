	...
	<div class="top-bar-right" style="background: #c1bdba;">
      ...
      <li><input type="search" style="height: 30px; width: 300px;"
       ...
       <li>      
        ...
        <button type="submit" class="button" style="height:30px; line-height:0.3rem;background-color: rgb(43,155,229);padding: 10px;color: white;font-size: 15px;" >Search
        </button>       
        </li>
         </form>
         <li>
          ...
          <input type="hidden"  name="userId" value=<%=userId%> />
          <button id="" class="button" type="submit"  style="height:30px; line-height:0.3rem;width:200px; background-color: rgb(43,155,229); padding: 10px;font-size: 15px;">Post an Item
                </button>
        </form>
        </li>
        <li>
...
<%
			...
			String faddr=(String)request.getAttribute("faddr");
	...
	<div id="formName" style=" " class="formInput">
		<form method="post" action="Updateprofileserv" style="text-align: center;">
			...
			<div id="col1" >
					...
					<label>Address
						<input type="text" placeholder="" value= <%=faddr%> name="faddr" >
					</label>
					<label>City
						<input type="text" placeholder="" value= <%=city%> name="city" >
					</label>
					<label>State
						<input type="text" placeholder="" value= <%=state%> name="state" >
					</label>
					<label>Zip
						<input type="text" placeholder="" value= <%=zip%> name="zip" >
					</label>
				...
				<input type="submit" class="button center" style="font-size: 15px;" value="Save profile"> 
